...
std::vector<int> Analysis::BFS(int* adjacency) {
...
std::vector<double> Analysis::Linearity(double* x, double* y, double* z, std::vector<int> chain, std::vector<int> unique, std::vector<int> size) {
...
bool Analysis::PreAnalysis(double* x, double* y, double* z, double time) {
	iteration_++;
...
void Analysis::WriteStress(int repetition, std::string tag) {

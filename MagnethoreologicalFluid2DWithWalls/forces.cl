...
__kernel void forces (
	...
	global const int* matrix_size, global const int* particle_0_array, global const int* particle_1_array, global double* forces_x, global double* forces_y, global double* forces_z
		...
		if (*dimensions == 2) {
			...
			distances[1] = (sqrt(pown(x_0[particle_1] - x_0[particle_0], 2) + pown(y_0[particle_1] - y_0[particle_0] - (*length_), 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[2] = (sqrt(pown(x_0[particle_1] - x_0[particle_0] + (*length_), 2) + pown(y_0[particle_1] - y_0[particle_0] - (*length_), 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[3] = (sqrt(pown(x_0[particle_1] - x_0[particle_0] + (*length_), 2) + pown(y_0[particle_1] - y_0[particle_0], 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[4] = (sqrt(pown(x_0[particle_1] - x_0[particle_0] + (*length_), 2) + pown(y_0[particle_1] - y_0[particle_0] + (*length_), 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[5] = (sqrt(pown(x_0[particle_1] - x_0[particle_0], 2) + pown(y_0[particle_1] - y_0[particle_0] + (*length_), 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[6] = (sqrt(pown(x_0[particle_1] - x_0[particle_0] - (*length_), 2) + pown(y_0[particle_1] - y_0[particle_0] + (*length_), 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[7] = (sqrt(pown(x_0[particle_1] - x_0[particle_0] - (*length_), 2) + pown(y_0[particle_1] - y_0[particle_0], 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			distances[8] = (sqrt(pown(x_0[particle_1] - x_0[particle_0] - (*length_), 2) + pown(y_0[particle_1] - y_0[particle_0] - (*length_), 2) + pown(z_0[particle_1] - z_0[particle_0], 2)));
			int index = 0;
			for(int j = 0; j < 9; j++) {
				if (distances[index] > distances[j]){ index = j; }
			}
